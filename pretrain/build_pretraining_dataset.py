...
class ExampleBuilder(object):
    ...
    def __init__(self, tokenizer, max_length, tokenizer_type):
    ...
    def add_line(self, line):
        ...
        if (
            self._current_length >= self._target_length
        ):  # If cur_len is longer than max_len
            return self._create_example()
        return None
...
class ExampleWriter(object):
    ...
    def __init__(
        ...
        self._example_builder = ExampleBuilder(
            tokenizer, max_seq_length, tokenizer_type
        )
        self._writers = []
...
def main():
    ...
    parser.add_argument(
        "--corpus_dir", required=True, help="Location of pre-training text files."
    )
    parser.add_argument(
        "--output_dir", required=True, help="Where to write out the tfrecords."
    )
    parser.add_argument(
        "--vocab_file", required=True, help="Location of vocabulary file."
    )
    parser.add_argument(
        "--max_seq_length", default=512, type=int, help="Number of tokens per example."
    )
    parser.add_argument(
        "--num_processes",
        default=4,
    ...
    parser.add_argument(
        ...
        default="wordpiece",
        type=str,
        help="Select the tokenizer algorithm to use. (wordpiece/mecab_wordpiece)",
    )
    parser.add_argument(
